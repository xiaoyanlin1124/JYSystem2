			...
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1">
					<div class="login-container">
						<div class="center">
							<h1><i class="icon-apple black"></i> <i class="icon-android black"></i> <span class="red">CEQ</span>&nbsp;<span class="white">System</span></h1>
						...
						<div class="position-relative">
							<div id="login-box" class="login-box visible widget-box no-border">
								...
								<a href="http://www.miitbeian.gov.cn"  style="text-align: center;" class="user-signup-link">粤ICP备17038720号-3</a>
								</div>
							</div>
							<!-- /login-box -->

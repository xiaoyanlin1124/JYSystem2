				...
				<table id="baseTable" class="table table-striped table-bordered table-hover" >
					<thead>
						<tr>
							...
							<th style="width:10%" class="center hidden-480">设备ID</th>
							<th style="width:9%" class="center hidden-480">型号</th>
							<th style="width:10%" class="center">模块ID</th>
							...
							<th style="width:9%" class="center hidden-480" ><i class="icon-time bigger-110 hidden-480"></i>最后消息</th>
							<th style="width:9%" class="center hidden-480" >IP地址</th>
							<th style="width:9%" class="center hidden-480" >地区</th>
							<!-- <th style="width:10%" class="center hidden-480" ><i class="icon-time bigger-110 hidden-480"></i>出厂时间</th> -->
...
<script src="${jypath}/static/js/system/device/onlineDevice.js"></script>
</body>
</html>
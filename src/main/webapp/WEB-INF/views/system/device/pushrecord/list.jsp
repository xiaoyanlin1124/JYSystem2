				...
				<table id="baseTable" class="table table-striped table-bordered table-hover" >
					<thead>
						<tr>
							...
							<th style="width:10%" class="center hidden-480" ><i class="icon-time bigger-110 hidden-480"></i>创建时间</th>
							<th style="width:20%" class="center">用户token</th>
							<th style="width:20%" class="center">推送平台key</th>
							<th style="width:20%" class="center">消息</th>
						</tr>
					</thead> 
					<tbody></tbody>
				</table>
...
<script src="${jypath}/static/js/system/device/PushRecord.js"></script>
</body>
</html>
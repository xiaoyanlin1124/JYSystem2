				...
				<table id="baseTable" class="table table-striped table-bordered table-hover" >
					<thead>
						<tr>
							...
							<th style="width:15%" class="center hidden-480">设备ID</th>
							<th style="width:10%" class="center">设备型号</th>
							...
							<th style="width:10%" class="center hidden-480" >token</th>
							<th style="width:2%" class="center hidden-480" >平台</th>
							<th style="width:5%" class="center">推送数量</th>
							<!-- <th style="width:10%" class="center hidden-480" ><i class="icon-time bigger-110 hidden-480"></i>创建时间</th> -->
							<th style="width:10%" class="center hidden-480" ><i class="icon-time bigger-110 hidden-480"></i>修改时间</th>
...
<script src="${jypath}/static/js/system/device/PushDevice.js"></script>
</body>
</html>
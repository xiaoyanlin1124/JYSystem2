				...
				<table id="baseTable" class="table table-striped table-bordered table-hover" >
					<thead>
						<tr>
							...
							<th style="width:8%" class="center hidden-480">呢称</th>
							<th style="width:4%" class="center hidden-480">第三方</th>
							<th style="width:10%" class="center">邮箱</th>
							<th style="width:10%" class="center hidden-480" >电话</th>
							<th style="width:5%" class="center hidden-480" >状态</th>
							<th style="width:5%" class="center hidden-480" >失败次数</th>
							<th style="width:5%" class="center hidden-480" >语言</th>
							<th style="width:8%" class="center hidden-480" >IP</th>
							<th style="width:10%" class="center hidden-480" >IP修改时间</th>
							<th style="width:10%" class="center hidden-480" >创建时间</th>
							<th style="width:8%" class="center hidden-480" >描述</th>
...
<script src="${jypath}/static/js/system/user/usercamear.js"></script>
</body>
</html>
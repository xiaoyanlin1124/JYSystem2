...
public class PushNcMsg
{
    ...
    private static  String appId = "100329529";//用户在华为开发者联盟申请的appId和appSecret（会员中心->我的产品，点击产品对应的Push服务，点击“移动应用详情”获取）
    ...
    {
        System.out.println(tokenExpiredTime+"---------------"+System.currentTimeMillis());
        ...
        param.put("appPkgName", "com.ceqsmart.ceq");//定义需要打开的appPkgName
